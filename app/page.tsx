    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-100">
        <section className="text-center max-w-lg">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-blue-600 animate-pulse">Vishesh Sachan</h1>
          <p className="text-base md:text-lg mb-6">B.Tech CSE Student | MERN Stack Developer | Learning Rust</p>
        </section>
