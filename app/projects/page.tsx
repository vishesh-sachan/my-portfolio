  ...
  return (
    <>
      ...
      <div className="p-8 bg-gray-100 flex flex-col items-center text-center">
        ...
        {projects.length === 0 ? (
          <p className="text-lg text-gray-700">No projects yet</p>
        ) : (
        ...
        {projects.map((project, index) => (
          ...
          <a href={project.liveLink} target="_blank" rel="noopener noreferrer" className="text-blue-500 mt-4 block">Live Demo</a>
            ...
            {project.blogLink && (
          <a href={project.blogLink} target="_blank" rel="noopener noreferrer" className="text-blue-500 mt-4 block text-xs">More About Project</a>
            )}
          </div>
        ))}
          </div>
